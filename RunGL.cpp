...
//rotateLion += rotateModel;

ivy_SHELL_ROTATE[3]       += rotateModel;
ivyLeaves_FRONT_ROTATE[3] += rotateModel;
ivyLeaves_REAR_ROTATE[3]  += rotateModel;
ivy_STONE_ROTATE[3]       += rotateModel;

paintSphere_ROTATE[3]       += rotateModel;

horns_ROTATE[3]       += rotateModel;
...
configureShader = 1;
   ...
   if (keys['L'] && !keys[VK_SHIFT] && !keys[VK_CONTROL])
    {
            basic_LIGHT_POSITION_01[0]         +=  .0201;
    }
    ...
    {
            basic_LIGHT_POSITION_01[1]         +=  .0201;
    } 
    ...
    {
            basic_LIGHT_POSITION_01[2]         +=  .0201;
    }
